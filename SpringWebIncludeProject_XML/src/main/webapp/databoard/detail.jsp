...
<body>
	<div class="row rowq">
		...
		<table class="table">
			...
			<tr>
				<th class="success text-center" width=20%>작성자</th>
			...
			<tr>
				<th class="success text-center" width=20%>첨부파일</th>
				<td colspan=3>
					<ul>
			...
			<tr>
				<td colspan=4 class="text-right">
					<a href="../databoard/update.do?no=${vo.no }" class="btn btn-sm btn-default">수정</a>
					<a href="../databoard/delete.do?no=${vo.no }" class="btn btn-sm btn-default">삭제</a>
					<a href="../databoard/list.do" class="btn btn-sm btn-default">목록</a>
				</td>
			</tr>
		</table>
	</div>
