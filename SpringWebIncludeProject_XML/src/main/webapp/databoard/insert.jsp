...
<body>
	<div class="row row1">
		...
		<table class="table">
			<tr>
				<th width=15% class="text-right success">작성자</th>
			...
			<tr>
				...
				<td width=85%>
					<table class="table">
						<tr>
							<td class="text-right">
								<input type=button value=추가 class="btn btn-xs btn-default" id="addBtn">
								<input type=button value=삭제 class="btn btn-xs btn-default" id="removeBtn">
							</td>
						</tr>
					</table>
			...
			<tr>
				<td colspan=2 class="text-center">
					<button class="btn btn-sm btn-success">작성</button>
